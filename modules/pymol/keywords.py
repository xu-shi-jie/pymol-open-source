...
def get_command_keywords(self_cmd=cmd):
    ...
    return {
        ...
        'get_property'  : [ self_cmd.get_property      , 0 , 0 , ''  , parsing.STRICT ],
        'get_property_list' : [ self_cmd.get_property_list , 0 , 0 , ''  , parsing.STRICT ],
        ...
        'set_property'  : [ self_cmd.set_property      , 0 , 0 , ''  , parsing.STRICT ],
        'set_atom_property' : [ self_cmd.set_atom_property , 0 , 0 , ''  , parsing.STRICT ],
